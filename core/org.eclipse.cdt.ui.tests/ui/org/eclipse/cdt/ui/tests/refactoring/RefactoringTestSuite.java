...
import org.eclipse.cdt.ui.tests.refactoring.encapsulatefield.EncapsulateFieldRefactoringTestBase;
...
public class RefactoringTestSuite extends TestSuite {
	...
	public static Test suite() throws Exception {
		...
		suite.addTest(EncapsulateFieldRefactoringTestBase.suite());
		return suite;
	}
}
